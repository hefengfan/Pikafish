...
Bitboard Position::attackers_to(Square s, Bitboard occupied) const {
    ...
    return (WhitePawnAttacks[s] & pieces(WHITE, PAWN))
         | (BlackPawnAttacks[s] & pieces(BLACK, PAWN))
         | (KnightAttacks[s] & pieces(KNIGHT))
         | (get_rook_attacks(s, occupied) & pieces(ROOK))
         | (get_cannon_attacks(s, occupied) & pieces(CANNON))
         | (get_bishop_attacks(s, occupied) & pieces(BISHOP))
         | (AdvisorAttacks[s] & pieces(ADVISOR))
